...
public class Serializing {
	...
	public static String getSerializedObject(Object obj) throws Exception {
		...
		if(qualifiedName.equals("java.lang.String")) {//String
			return "<string>"+(String)obj+"</string>";
		}
		if(qualifiedName.equals("java.util.Date")) {//Date
			return "<DateTime>"+DateTimeFormat.getFormat("yyyyMMddHHmmss").format((Date)obj)+"</DateTime>";
		}
		if(qualifiedName.equals("java.util.ArrayList")) {//ArrayList<T>
			return getSerializedArrayList(obj);
		}
		if(qualifiedName.equals("com.opendental.opendentbusiness.data.DataTable")) {//ArrayList<T>
			// TODO Enhance web service to handle DataTable's as parameters.
		}
		//Arrays------------------------------------------------------------------------------------------------------------
	...
	private static String getSerializedArrayList(Object obj) throws Exception {
		String result="<List>";
		ArrayList<Object> listObjs=(ArrayList<Object>)obj;
		for(int i=0;i<listObjs.size();i++) {
			result+=getSerializedObject(listObjs.get(i));
		}
		result+="</List>";
		return result;
	}
