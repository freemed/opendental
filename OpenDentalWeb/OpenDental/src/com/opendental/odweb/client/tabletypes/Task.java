...
public class Task {
		...
		public String SerializeToXml() {
			...
			sb.append("<DateTask>").append(Serializing.EscapeForXml(DateTask)).append("</DateTask>");
			...
			sb.append("<DateTimeFinished>").append(Serializing.EscapeForXml(DateTimeFinished)).append("</DateTimeFinished>");
			sb.append("</Task>");
			return sb.toString();
		}
		...
		public void DeserializeFromXml(String xml) throws Exception {
			try {
				...
				DateTask=doc.getElementsByTagName("DateTask").item(0).getFirstChild().getNodeValue();
				...
				DateTimeFinished=doc.getElementsByTagName("DateTimeFinished").item(0).getFirstChild().getNodeValue();
			}
			catch(Exception e) {
				throw e;
			}
