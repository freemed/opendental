...
public class InstallmentPlan {
		...
		public String SerializeToXml() {
			...
			sb.append("<DateAgreement>").append(Serializing.EscapeForXml(DateAgreement)).append("</DateAgreement>");
			sb.append("<DateFirstPayment>").append(Serializing.EscapeForXml(DateFirstPayment)).append("</DateFirstPayment>");
		...
		public void DeserializeFromXml(String xml) throws Exception {
			try {
				...
				DateAgreement=doc.getElementsByTagName("DateAgreement").item(0).getFirstChild().getNodeValue();
				DateFirstPayment=doc.getElementsByTagName("DateFirstPayment").item(0).getFirstChild().getNodeValue();
