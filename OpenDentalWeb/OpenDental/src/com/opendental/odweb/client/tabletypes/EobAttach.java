...
public class EobAttach {
		...
		public String SerializeToXml() {
			...
			sb.append("<DateTCreated>").append(Serializing.EscapeForXml(DateTCreated)).append("</DateTCreated>");
		...
		public void DeserializeFromXml(String xml) throws Exception {
			try {
				...
				DateTCreated=doc.getElementsByTagName("DateTCreated").item(0).getFirstChild().getNodeValue();
