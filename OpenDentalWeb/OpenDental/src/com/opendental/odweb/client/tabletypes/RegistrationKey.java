...
public class RegistrationKey {
		...
		public String SerializeToXml() {
			...
			sb.append("<DateStarted>").append(Serializing.EscapeForXml(DateStarted)).append("</DateStarted>");
			sb.append("<DateDisabled>").append(Serializing.EscapeForXml(DateDisabled)).append("</DateDisabled>");
			sb.append("<DateEnded>").append(Serializing.EscapeForXml(DateEnded)).append("</DateEnded>");
		...
		public void DeserializeFromXml(String xml) throws Exception {
			try {
				...
				DateStarted=doc.getElementsByTagName("DateStarted").item(0).getFirstChild().getNodeValue();
				DateDisabled=doc.getElementsByTagName("DateDisabled").item(0).getFirstChild().getNodeValue();
				DateEnded=doc.getElementsByTagName("DateEnded").item(0).getFirstChild().getNodeValue();
