...
namespace Dosadi.EZTwain
{
    ...
    public abstract class EZTwain
    {
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_BeginAcquireMemory")] public static extern
        bool BeginAcquireMemory(System.IntPtr hwnd, int nRows);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_AcquireMemoryBlock")] public static extern
        System.IntPtr AcquireMemoryBlock();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_EndAcquireMemory")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetDefaultScanAnotherPagePrompt")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_DoSettingsDialog")] public static extern
        int DoSettingsDialog(System.IntPtr hwnd);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_EnableSourceUiOnly")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_WaitForImage")] public static extern
        ...
        int EasyVersion();
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_EasyBuild")] public static extern
        int EasyBuild();
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_IsDone")] public static extern
        bool IsDone();
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_IsDcxAvailable")] public static extern
        bool IsDcxAvailable();
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_FormatVersion")] public static extern
        int FormatVersion(int nFF);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_IsFileExtensionAvailable")] public static extern
        bool IsFileExtensionAvailable(string sExt);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_FormatFromExtension")] public static extern
        int FormatFromExtension(string sExt, int nFF);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ExtensionFromFormat")] public static extern
        string ExtensionFromFormat(int nFF, string sDefExt);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetExtensionFromFormat")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetTiffTagShort")] public static extern
        bool SetTiffTagShort(int nTagId, int sValue);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetTiffTagLong")] public static extern
        bool SetTiffTagLong(int nTagId, int nValue);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetTiffTagString")] public static extern
        bool SetTiffTagString(int nTagId, string sText);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetTiffTagDouble")] public static extern
        bool SetTiffTagDouble(int nTagId, double dValue);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetTiffTagRational")] public static extern
        bool SetTiffTagRational(int nTagId, double dValue);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetTiffTagRationalArray")] public static extern
        bool SetTiffTagRationalArray(int nTagId, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2)] double[] dValues, int n);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetTiffTagBytes")] public static extern
        bool SetTiffTagBytes(int nTagId, System.IntPtr pdata, int nBytes);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ResetTiffTags")] public static extern
        void ResetTiffTags();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetTiffTagAscii")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetPdfTitle")] public static extern
        bool SetPdfTitle(string sText);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetPdfAuthor")] public static extern
        bool SetPdfAuthor(string sText);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetPdfSubject")] public static extern
        bool SetPdfSubject(string sText);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetPdfKeywords")] public static extern
        bool SetPdfKeywords(string sText);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetPdfCreator")] public static extern
        bool SetPdfCreator(string sText);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetPdfProducer")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_WriteToFilename")] public static extern
        int WriteToFilename(System.IntPtr hdib, string sFileName);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_LoadFromFilename")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_PagesInFile")] public static extern
        int PagesInFile(string sFileName);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ViewFile")] public static extern
        int ViewFile(string sFileName);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetViewOption")] public static extern
        bool SetViewOption(string sOption, string sValue);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_IsViewOpen")] public static extern
        bool IsViewOpen();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ViewClose")] public static extern
        bool ViewClose();
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetLazyWriting")] public static extern
        void SetLazyWriting(bool bYes);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetLazyWriting")] public static extern
        bool GetLazyWriting();
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_LastOutputFile")] public static extern
        string LastOutputFile();


        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetOutputPageCount")] public static extern
        void SetOutputPageCount(int nPages);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_FileCopy")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ApplicationLicense")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_OrganizationLicense")] public static extern
        void OrganizationLicense(string sOrganization, int nKey);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_RenewTrialLicense")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ReportLeaks")] public static extern
        bool ReportLeaks();
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_Shutdown")] public static extern
        void Shutdown();
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetXResolution")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetResolutionInt")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetAutoDeskew")] public static extern
        void SetAutoDeskew(int nMode);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetAutoDeskew")] public static extern
        int GetAutoDeskew();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetBlankPageMode")] public static extern
        void SetBlankPageMode(int nMode);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetBlankPageMode")] public static extern
        int GetBlankPageMode();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetBlankPageThreshold")] public static extern
        void SetBlankPageThreshold(double dDarkness);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetBlankPageThreshold")] public static extern
        double GetBlankPageThreshold();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetAutoCrop")] public static extern
        void SetAutoCrop(int nMode);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetAutoCrop")] public static extern
        int GetAutoCrop();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetAutoContrast")] public static extern
        void SetAutoContrast(int nMode);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetAutoContrast")] public static extern
        int GetAutoContrast();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetAutoOCR")] public static extern
        void SetAutoOCR(int nMode);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetAutoOCR")] public static extern
        int GetAutoOCR();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetAutoNegate")] public static extern
        void SetAutoNegate(bool bYes);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetAutoNegate")] public static extern
        bool GetAutoNegate();
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetPaperDimensions")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetGrayResponse")] public static extern
        bool SetGrayResponse([MarshalAs(UnmanagedType.LPArray, SizeConst=256)] int[] pcurve);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetColorResponse")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ResetGrayResponse")] public static extern
        bool ResetGrayResponse();
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ResetColorResponse")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_IsCapAvailable")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetCapability")] public static extern
        bool SetCapability(int cap, double dValue);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetCapString")] public static extern
        bool SetCapString(int cap, string sValue);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetCapBool")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetCapUint32")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetCustomDataToFile")] public static extern
        bool GetCustomDataToFile(string sFilename);
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetCustomDataFromFile")] public static extern
        bool SetCustomDataFromFile(string sFilename);


        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_IsExtendedInfoSupported")] public static extern
        bool IsExtendedInfoSupported();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_EnableExtendedInfo")] public static extern
        bool EnableExtendedInfo(int eiCode, bool enabled);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_IsExtendedInfoEnabled")] public static extern
        bool IsExtendedInfoEnabled(int eiCode);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_DisableExtendedInfo")] public static extern
        void DisableExtendedInfo();

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ExtendedInfoItemCount")] public static extern
        int ExtendedInfoItemCount(int eiCode);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ExtendedInfoItemType")] public static extern
        int ExtendedInfoItemType(int eiCode);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ExtendedInfoInt")] public static extern
        int ExtendedInfoInt(int eiCode, int n);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ExtendedInfoFloat")] public static extern
        double ExtendedInfoFloat(int eiCode, int n);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetExtendedInfoString")] public static extern
        bool GetExtendedInfoString(int eiCode, int n, StringBuilder Buffer, int Bufsize);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_ExtendedInfoString")] public static extern
        string ExtendedInfoString(int eiCode, int n);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_GetExtendedInfoFrame")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetImageReadyTimeout")] public static extern
        ...
        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_SetLogFolder")] public static extern
        void SetLogFolder(string sFolder);

        [DllImport("Eztwain3.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_LogFileName")] public static extern
        string LogFileName();
