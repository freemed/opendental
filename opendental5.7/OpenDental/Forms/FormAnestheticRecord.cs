...
namespace OpenDental {
	public class FormAnestheticRecord : System.Windows.Forms.Form{
		...
		private void InitializeComponent(){
			...
			// groupBoxAnesthMeds
			// 
			this.groupBoxAnesthMeds.Controls.Add(this.butAnesthMedIntake);
