	...
	public partial class Form1:Form {
		...
		private void StartJavaSerial(StringBuilder strb) {
			...
			strb.Append("package com.opendental.odweb.client.remoting;"+rn
				...
				+"import com.opendental.odweb.client.tabletypes.*;"+rn
				+"import com.google.gwt.xml.client.Node;"+rn
				+"import com.google.gwt.xml.client.NodeList;"+rn+rn
				+"/** Do not make changes to this file.  This class is automatically generated by the CRUD, any changes made will be overwritten.  To make changes, go to xCrudGeneratorWebService.Form1.cs and make the changes within StartJavaSerial(). */"+rn
