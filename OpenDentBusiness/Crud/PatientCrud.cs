	...
	internal class PatientCrud {
		...
		internal static void Delete(long patNum){
			...
			Db.NonQ(command);
				...
				/*
				command="DROP TABLE IF EXISTS patient";
				Db.NonQ(command);
				command=@"CREATE TABLE patient (
					...
					FamFinUrgNote varchar(255) NOT NULL,
					MedUrgNote varchar(255) NOT NULL,
					ApptModNote varchar(255) NOT NULL,
					StudentStatus varchar(255) NOT NULL,
					SchoolName varchar(255) NOT NULL,
					ChartNumber varchar(255) NOT NULL,
					...
					EmploymentNote varchar(255) NOT NULL,
					...
					HasIns varchar(255) NOT NULL,
					TrophyFolder varchar(255) NOT NULL,
					PlannedIsDone tinyint NOT NULL,
					...
					SchedBeforeTime time NOT NULL,
					SchedAfterTime time NOT NULL,
