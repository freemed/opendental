//This file is automatically generated, most recently on 4/21/2010 9:37:19 AM
...
namespace OpenDentBusiness.Crud{
	internal class AccountCrud {
		///<summary>Gets one Account object from the database using the primary key.</summary>
