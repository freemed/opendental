...
namespace OpenDentBusiness.Crud{
	internal class SheetFieldCrud {
		...
		internal static long Insert(SheetField sheetField,bool useExistingPK){
			...
			command+="SheetNum,FieldType,FieldName,FieldValue,FontSize,FontName,FontIsBold,XPos,YPos,Width,Height,GrowthBehavior,RadioButtonValue) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
			...
			if(useExistingPK || PrefC.RandomKeys) {
				...
				sheetField.SheetFieldNum=Db.NonQ(command,true);
			}
		...
		internal static void Delete(long sheetFieldNum){
			...
			Db.NonQ(command);
				...
				command=@"CREATE TABLE sheetfield (
					SheetFieldNum bigint NOT NULL auto_increment,
