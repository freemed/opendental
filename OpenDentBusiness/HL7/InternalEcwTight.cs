...
namespace OpenDentBusiness.HL7 {
	...
	public class InternalEcwTight {
		...
		public static HL7Def GetHL7Def() {
			...
			//PID.2, Patient ID
			seg.AddField(2,DataTypeHL7.CX,"pat.PatNum");//TODO: PatNum in tight integration, ChartNum in stand alone mode.
			//PID.4, Alternate Patient ID
			seg.AddField(4,DataTypeHL7.CX,"pat.ChartNumber");//TODO: PID.4 is not saved with using standalone integration
			//PID.5, Patient Name
			...
			seg.AddField(3,DataTypeHL7.CWE,"prov.provNumName");
			//PV1 segment.-----------------------------------------------------------------
			seg=new HL7DefSegment();
			msg.AddSegment(seg,3,false,true,SegmentNameHL7.PV1);
			//PV1.7, Attending/Primary Care Doctor
			seg.AddField(7,DataTypeHL7.XCN,"prov.provNumNameLFM");
			//------------------------------------------------------------------------------------------------------------------------------------
			...
			seg.AddField(6,DataTypeHL7.DTM,"curDateTime");
			//MSH.8, Message Type^Event Type
			seg.AddFieldFixed(8,DataTypeHL7.MSG,"DFT^P03");
			...
			//EVN.1, Event Type
			seg.AddFieldFixed(1,DataTypeHL7.ID,"P03");
			//EVN.2, Recorded Date/Time
			seg.AddField(2,DataTypeHL7.DTM,"curDateTime");
			...
			seg.AddField(4,DataTypeHL7.DTM,"proclog.procDateTime");
			//FT1.5, Transaction Posting Date (YYYYMMDDHHMMSS)
			seg.AddField(5,DataTypeHL7.DTM,"proclog.procDateTime");
			...
			seg.AddField(19,DataTypeHL7.CWE,"proclog.DiagnosticCode");
