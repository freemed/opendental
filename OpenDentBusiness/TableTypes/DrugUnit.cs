...
namespace OpenDentBusiness {
	///<summary>We will only prefill this list with units needed for the tests.  Users would have to manually add any other units.</summary>
	[Serializable]
	public class DrugUnit:TableBase {
		///<summary>Primary key.</summary>
		[CrudColumn(IsPriKey=true)]
		public long DrugUnitNum;
		///<summary>Example ml.</summary>
