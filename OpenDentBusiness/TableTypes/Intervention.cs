...
namespace OpenDentBusiness {
	///<summary>An intervention ordered or performed.  Examples: smoking cessation and weightloss counseling.  Links to a definition in the ehrcode table using the ValueSetID, CodeValue, and CodeSystem.</summary>
	[Serializable]
