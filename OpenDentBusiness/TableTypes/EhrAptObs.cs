...
namespace OpenDentBusiness {
	...
	public class EhrAptObs:TableBase {
		...
		///<summary>When ValType is Coded, then this contains the code system corresponding to the code in ValReported.  When ValType is not Coded, then this field should be blank.</summary>
