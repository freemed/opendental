...
namespace OpenDentBusiness {
	...
	public class EhrNotPerformed:TableBase {
		...
		///<summary>FK to ehrcode.CodeValue.  The code for this item from one of the code systems supported, e.g. ICD9CM or SNOMEDCT.  Example: 666.22 or 10197000.</summary>
