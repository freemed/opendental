...
<body id="bodytag" runat="server" class="style1" bgcolor="#3B756E">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            --%>
                    ...
                    <asp:CalendarExtender ID="TextBoxBirthdate_CalendarExtender" runat="server" Enabled="True"
                        Format="MM/dd/yyyy" TargetControlID="TextBoxBirthdate">
                    ...
                    <asp:Panel ID="Panel3" runat="server" Style="text-align: right; font-weight: bold;">
                        <asp:Button ID="SUBMIT2" runat="server" Text="SUBMIT" CssClass="buttonstyle" />
                    </asp:Panel>
                    <br />
                </asp:Panel>
            </ContentTemplate>
