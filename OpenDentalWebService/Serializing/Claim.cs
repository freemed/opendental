...
namespace OpenDentalWebService {
	...
	public class Claim {
		...
		public static string Serialize(OpenDentBusiness.Claim claim) {
			...
			sb.Append("<DateService>").Append(claim.DateService.ToLongDateString()).Append("</DateService>");
			sb.Append("<DateSent>").Append(claim.DateSent.ToLongDateString()).Append("</DateSent>");
			sb.Append("<ClaimStatus>").Append(SerializeStringEscapes.EscapeForXml(claim.ClaimStatus)).Append("</ClaimStatus>");
			sb.Append("<DateReceived>").Append(claim.DateReceived.ToLongDateString()).Append("</DateReceived>");
			...
			sb.Append("<PriorDate>").Append(claim.PriorDate.ToLongDateString()).Append("</PriorDate>");
			...
			sb.Append("<AccidentDate>").Append(claim.AccidentDate.ToLongDateString()).Append("</AccidentDate>");
			...
			sb.Append("<OrthoDate>").Append(claim.OrthoDate.ToLongDateString()).Append("</OrthoDate>");
			...
			sb.Append("<CanadianDateInitialLower>").Append(claim.CanadianDateInitialLower.ToLongDateString()).Append("</CanadianDateInitialLower>");
			...
			sb.Append("<CanadianDateInitialUpper>").Append(claim.CanadianDateInitialUpper.ToLongDateString()).Append("</CanadianDateInitialUpper>");
			...
			sb.Append("<CanadaEstTreatStartDate>").Append(claim.CanadaEstTreatStartDate.ToLongDateString()).Append("</CanadaEstTreatStartDate>");
			...
			sb.Append("<DateResent>").Append(claim.DateResent.ToLongDateString()).Append("</DateResent>");
