...
namespace OpenDentalWebService {
	...
	public class ErxLog {
		...
		public static string Serialize(OpenDentBusiness.ErxLog erxlog) {
			...
			sb.Append("<DateTStamp>").Append(erxlog.DateTStamp.ToString("yyyyMMddHHmmss")).Append("</DateTStamp>");
			sb.Append("</ErxLog>");
			return sb.ToString();
		}
				...
				while(reader.Read()) {
					...
					switch(reader.Name) {
						...
						case "MsgText":
							...
							break;
						case "DateTStamp":
							erxlog.DateTStamp=DateTime.ParseExact(reader.ReadContentAsString(),"yyyyMMddHHmmss",null);
							break;
					}
				}
			}
