...
namespace OpenDentalWebService {
	...
	public static class aaGeneralTypes {
		...
		///<summary>Goes through all the possible types of objects and returns the object serialized for Java.  objectType must be fully qualified.  Ex: System.Int32.  For DataTables, set objectType to "DataT".  Returns an empty node if the object is null.  Throws exceptions.</summary>
		public static string Serialize(string objectType,Object obj) {
			if(obj==null) {
				return "<"+objectType+"/>";//Return an empty node?
			}
			//Primitives--------------------------------------------------------------------
			if(objectType=="System.Int32") {
				return "<int>"+OpenDentBusiness.POut.Int((int)obj)+"</int>";
			}
			if(objectType=="System.Int64") {//Web app does not use longs.
