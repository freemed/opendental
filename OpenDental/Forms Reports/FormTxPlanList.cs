	...
	public class FormTxPlanList:System.Windows.Forms.Form {
		...
		private void FillSummary(long PatNum,
			...
			if(PatPlanList.Count > 0) {
				...
				PriPend = pend;
				used = InsPlans.GetInsUsedDisplay(histList,DateTime.Today,PlanCur.PlanNum,PatPlanList[0].PatPlanNum,-1,InsPlanList,BenefitList,PatNum);
				PriUsed = used;
			...
			if(PatPlanList.Count > 1) {
				...
				SecPend = pend;
				used = InsPlans.GetInsUsedDisplay(histList,DateTime.Today,PlanCur.PlanNum,PatPlanList[1].PatPlanNum,-1,InsPlanList,BenefitList,PatNum);
				SecUsed = used;
