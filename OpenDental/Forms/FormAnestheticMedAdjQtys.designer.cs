namespace OpenDental{
	partial class FormAnestheticMedsAdjQtys
	{
		...
		private void InitializeComponent() {
			...
			//(System.ComponentModel.ISupportInitialize)(this.gridAnesthMedsAdjQty)).BeginInit();
			this.SuspendLayout();
			// 
			// labelAdjustQtys
			// 
			...
			this.gridAnesthMedsAdjQty.Title = "Adjust Anesthetic Medication Inventory Quantities";
			this.gridAnesthMedsAdjQty.TranslationName = null;
			...
			//((System.ComponentModel.ISupportInitialize)(this.gridAnesthMedsAdjQty)).EndInit();
