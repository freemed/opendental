...
namespace OpenDental {
	public partial class FormEhrLabOrderEdit2014:Form {
		...
		private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			FormEhrLabResultEdit2014 FormLRE=new FormEhrLabResultEdit2014(EhrLabCur.ListEhrLabResults[e.Row]);
			FormLRE.ShowDialog();
			FillGrid();
		}

		private void butAdd_Click(object sender,EventArgs e) {
			EhrLabResult ehrLabResultCur=new EhrLabResult();
			ehrLabResultCur.IsNew=true;
			FormEhrLabResultEdit2014 FormLRE=new FormEhrLabResultEdit2014(ehrLabResultCur);
