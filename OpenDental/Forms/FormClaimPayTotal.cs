...
namespace OpenDental
{
	...
	public class FormClaimPayTotal : System.Windows.Forms.Form
	{
		...
		///<summary></summary>
		public FormClaimPayTotal(Patient patCur,Family famCur,List <InsPlan> planList,List<PatPlan> patPlanList){
    ...
    "the insurance EOB.";
		...
		private void gridMain_CellDoubleClick(object sender,OpenDental.UI.ODGridClickEventArgs e) {
			...
			FormClaimProc FormCP=new FormClaimProc(ClaimProcsToEdit[e.Row],null,FamCur,PatCur,PlanList,histList,ref loopList,PatPlanList);
