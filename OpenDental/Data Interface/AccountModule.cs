...
namespace OpenDental{
	public class AccountModule{
		...
		{
			return General.GetDS(MethodName.AccountModule_GetAll,patNum,viewingInRecall,fromDate,toDate,intermingled);
		}
		...
		{
			return General.GetDS(MethodName.AccountModule_GetStatement,patNum,singlePatient,fromDate,toDate,intermingled);
		}
