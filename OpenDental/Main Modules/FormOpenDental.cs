...
namespace OpenDental{
	...
	public class FormOpenDental:System.Windows.Forms.Form {
		...
		private void InitializeComponent(){
			...
			// 
			this.menuItemLaboratories.Index=14;
			...
			// menuItemMessaging
			// 
			this.menuItemMessaging.Index=15;
			...
			// 
			this.menuItemMessagingButs.Index=16;
			...
			// menuItemOperatories
			// 
			this.menuItemOperatories.Index=18;
			...
			// 
			this.menuItemPatFieldDefs.Index=19;
			...
			// menuItemPayPeriods
			// 
			this.menuItemPayPeriods.Index=20;
			...
			// 
			this.menuItemProcedureButtons.Index=22;
			...
			// menuItemQuestions
			// 
			this.menuItemQuestions.Index=24;
			...
			this.myOutlookBar.Size=new System.Drawing.Size(51,636);
			...
			// menuItemReplication
			// 
			this.menuItemReplication.Index=26;
		...
		private bool RefreshLocalData(InvalidTypes itypes,bool isStartingUp){
			if((itypes & InvalidTypes.Prefs)==InvalidTypes.Prefs){
				...
				if(isStartingUp){
					...
					Lan.Refresh();//automatically skips if current culture is en-US
					LanguageForeigns.Refresh(CultureInfo.CurrentCulture);//automatically skips if current culture is en-US
					menuItemReplication.Visible=PrefB.GetBool("RandomPrimaryKeys");
				}
