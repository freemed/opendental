...
namespace OpenDental{
	...
	public class FormOpenDental:System.Windows.Forms.Form {
		...
		private void InitializeComponent(){
			...
			// menuItemFeeScheds
			// 
			this.menuItemFeeScheds.Index = 12;
			...
			// 
			this.menuItemInsFilingCodes.Index = 15;
			...
			// menuItemReplication
			// 
			this.menuItemReplication.Index = 31;
			...
			// 
			this.menuItemCustomerManage.Index = 14;
			...
			// menuItemMobileSync
			// 
			this.menuItemMobileSync.Index = 15;
