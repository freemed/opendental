...
//		private UI.Button butShowDateRange;
		...
		///<summary>Only use this overload when isFullRefresh is set to false.  This is ONLY in a few places and only for eCW at this point.</summary>
...
//temp: remove this after testing:
				...
				if(!validKey) {
					...
					if(newCropName=="") {
						MsgBox.Show(this,"NewCropName preference must not be blank when using a NewCrop AccountID provided by a reseller.");
						return;
					}
				}
			}
